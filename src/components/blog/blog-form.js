...
export default class BlogForm extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://stephenforbes.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post"
        };
    ...
    componentWillMount() {
        if(this.props.editMode) {
            this.setState({
                ...
                apiUrl: `https://stephenforbes.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
                apiAction: "patch"
            })
        }
    }
    ...
    handleRichTextEditorChange(content) {
        //this is essentially content: content
        //if the key and the value are the same, you can just do this
